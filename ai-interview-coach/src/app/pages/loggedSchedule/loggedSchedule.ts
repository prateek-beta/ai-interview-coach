...
@Component({
  ...
  templateUrl: './loggedSchedule.html',
  styleUrl: './loggedSchedule.scss',
})
export class loggedSchedule implements OnInit {
  ...
  confirmLoggedInterview() {
    ...
    this.service.bookLoggedInInterview(formData).subscribe({
        next: () => {
          alert("Interview Scheduled");
          this.router.navigate(['/dashboard']);
        },
        error: () => alert("Error scheduling interview")
      });
